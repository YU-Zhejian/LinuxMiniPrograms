...
if not os.system("id -a &>> /dev/null || id &>> /dev/null"):
    ...
    print("\033[031mFailed to execute 'id -a'\033[0m")

if os.path.isfile("/etc/passwd"):
    print("\033[033mSystem information generated by '/etc/passwd':\033[0m")
    tbl=["#1","#1",'User name;User password;User ID;User group ID;User gecos;User home directory;User Shell']
    tbl.extend(ylread("/proc/version").replace(':',';').split('\n'))
    ylwrite(tmpf,'\n'.join(tbl))
    mktbl(tmpf)
else:
