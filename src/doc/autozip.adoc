...
Some algorithms (e.g. LZMA, Deflate) may support 0 which means to be store only without compression.
If [level] is omitted, this program will use default value provided by the algorithm.
