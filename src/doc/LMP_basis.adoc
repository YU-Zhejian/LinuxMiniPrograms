...
There should be no compatibility problems in this platform because this is what this suite of program designed for. Tested and fully supported.
...
All documentation for user is written in Asciidoc except the help file of `configure`, or some programs located under `opt/`.
