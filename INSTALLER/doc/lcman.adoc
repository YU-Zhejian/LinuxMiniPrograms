...
WARNING: For BSD users, please be aware that we will use `cat` instead of `more` here.
...
. `var/livechat.d/LCONLINE` The file containing information about online users.

. `var/livechat.d/MESSAGES` The file containing all messages.
